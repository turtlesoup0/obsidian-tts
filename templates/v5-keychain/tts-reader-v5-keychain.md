...
```
=== 노트 1/100: API ===
Cache Key: ***KEY_EXAMPLE***
📥 Checking server cache: ***KEY_EXAMPLE***
⚠️ Server cache MISS: ***KEY_EXAMPLE***
🌐 Azure TTS API 호출 시작
✅ TTS 생성 완료: 12345 bytes, 123 chars
📤 Saving to server cache: ***KEY_EXAMPLE***
✅ Server cached: ***KEY_EXAMPLE***, size: 12345 bytes
```
...
Cache Key: ***KEY_EXAMPLE***
📥 Checking server cache: ***KEY_EXAMPLE***
💾 Server cache HIT: ***KEY_EXAMPLE*** (12345 bytes) ⚡
